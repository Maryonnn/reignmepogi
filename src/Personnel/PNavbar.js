        ...
        <>
            ...
            >
                <div className="container">
                    ...
                    >
                        <NavLink to="/startup-teams" className="nav-link text-white">
                            <RiTeamFill size={20} className="me-1 mb-1" />
                            Startup Teams
                        </NavLink>
                        <NavLink to="/tbi-category" className="nav-link text-white">
                            <TbCategoryFilled size={20} className="me-1 mb-1" />
                            TBI Category
                        </NavLink>
                        <NavLink to="/milestone" className="nav-link text-white">
                        ...
                        <div className='mt-2'>
                            <Dropdown>
                                ...
                                <Dropdown.Menu>
                                    <Dropdown.Item href="#/action-1">Seed Funding</Dropdown.Item>
                                    <Dropdown.Item href="#/action-1">Competition</Dropdown.Item>
                                </Dropdown.Menu>
                            </Dropdown>
                        </div>
                    </Nav>
                    ...
                    <div className="d-lg-block d-none me-3">
                        <Dropdown>
                            ...
                            <Dropdown.Menu className="custom-dropdown-menu">
                                <Dropdown.Item href="#/action-1">Create Account</Dropdown.Item>
